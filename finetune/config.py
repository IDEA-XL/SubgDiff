...
#     ],
# )
parser.add_argument("--model_3d", type=str, default="mask_diff")
parser.add_argument(
    "--model_2d",
    type=str,
    default="gin",
...
## for mask diff (GeoDiff)
parser.add_argument('--ckpt', type=str,default="", help='path for loading the checkpoint')
