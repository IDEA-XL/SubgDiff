...
from torch_geometric.data import (InMemoryDataset, download_url, extract_zip,
                                  Data)
from datasets.rdmol2data import rdmol_to_data
...
class QM9(InMemoryDataset):
    ...
    def process(self):
        ...
        for i, mol in enumerate(tqdm(suppl)):
            ...
            # self.pyg_rdmol_to_data(mol, pos, target[i].unsqueeze(0), i)
            rdmol_to_data(mol=mol,pos=pos, y=target[i].unsqueeze(0), idx=i)
    ...
    def pyg_rdmol_to_data(self, mol, pos,target,i):
        type_idx = []
        atomic_number = []
        aromatic = []
        sp = []
